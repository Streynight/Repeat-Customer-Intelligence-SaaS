...
const thaiCopy: Record<string, string> = {
  ...
  'Create projects, share them with teammates, and keep owner-controlled project dates in one place.':
    'สร้างโปรเจกต์ แชร์ให้เพื่อนร่วมทีม และให้เจ้าของคุมช่วงเวลาโปรเจกต์ไว้ที่เดียว',
  ...
  'Marketplace order intelligence': 'ระบบวิเคราะห์ออเดอร์ marketplace',
  ...
  'Upload messy marketplace order exports. RepeatTree cleans the file, matches customers, and shows who is ready to buy again.':
    'อัปโหลดไฟล์ออเดอร์ marketplace ที่ไม่เป็นระเบียบ แล้ว RepeatTree จะ clean ไฟล์ รวมลูกค้า และบอกว่าใครพร้อมซื้อซ้ำ',
  Login: 'เข้าสู่ระบบ',
  ...
  'Upload order files': 'อัปโหลดไฟล์ออเดอร์',
  ...
  'Use Shopee, TikTok, Lazada, CSV, or XLSX exports without rebuilding the sheet.':
    'ใช้ไฟล์ export จาก Shopee, TikTok, Lazada, CSV หรือ XLSX โดยไม่ต้องจัดชีตใหม่',
  'Resolve customers': 'รวมตัวตนลูกค้า',
  'Clean customer data': 'ทำข้อมูลลูกค้าให้สะอาด',
  'Merge email, phone, LINE ID, and channel identity signals.': 'รวม email, เบอร์โทร, LINE ID และสัญญาณตัวตนจากทุกช่องทาง',
  'Map messy columns and merge buyers by email, phone, LINE ID, and channel identity.':
    'Map column ที่ไม่เหมือนกัน และรวมผู้ซื้อด้วย email, เบอร์โทร, LINE ID และตัวตนจากช่องทาง',
  'Act on repeat value': 'ลงมือจากมูลค่าซื้อซ้ำ',
  'Act on repeat buyers': 'ลงมือกับลูกค้าซื้อซ้ำ',
  'Prioritize VIP protection, second purchase, and win-back work.': 'จัดลำดับงานดูแล VIP, กระตุ้นซื้อครั้งที่สอง และ win-back',
  'Find VIP, second-purchase, and win-back queues your team can work this week.':
    'หา VIP, ลูกค้าที่ควรกระตุ้นซื้อครั้งที่สอง และคิว win-back ที่ทีมทำได้ในสัปดาห์นี้',
  ...
  'CSV/XLSX marketplace files': 'ไฟล์ marketplace CSV/XLSX',
  'Auto column mapping': 'Map column อัตโนมัติ',
  'Repeat buyer lists': 'รายชื่อลูกค้าซื้อซ้ำ',
  'Team access control': 'ควบคุมสิทธิ์ทีม',
  Workspace: 'Workspace',
  ...
  'Invite teammate': 'เชิญเพื่อนร่วมทีม',
  'Invitation role': 'Role ของคำเชิญ',
  'Member role': 'Role ของสมาชิก',
  'Send invite': 'ส่งคำเชิญ',
  'Sending...': 'กำลังส่ง...',
  'Invitation failed.': 'ส่งคำเชิญไม่สำเร็จ',
  'Invitation sent.': 'ส่งคำเชิญแล้ว',
  'Team role updated.': 'อัปเดต role ทีมแล้ว',
  'Team role update failed.': 'อัปเดต role ทีมไม่สำเร็จ',
  'Invitation revoke failed.': 'ยกเลิกคำเชิญไม่สำเร็จ',
  'Invitation revoked.': 'ยกเลิกคำเชิญแล้ว',
  'Teammate remove failed.': 'ลบเพื่อนร่วมทีมไม่สำเร็จ',
  'Teammate removed.': 'ลบเพื่อนร่วมทีมแล้ว',
  'Pending invitations': 'คำเชิญที่รอการตอบรับ',
  Expired: 'หมดอายุ',
  Expires: 'หมดอายุวันที่',
  Revoke: 'ยกเลิก',
  Remove: 'ลบ',
  Owner: 'เจ้าของ',
  Editor: 'ผู้แก้ไข',
  ...
  'Create an owner-controlled project and share it with teammates when ready.':
    'สร้างโปรเจกต์ที่เจ้าของคุมสิทธิ์ และแชร์ให้ทีมเมื่อพร้อม',
  'Project name': 'ชื่อโปรเจกต์',
  Description: 'รายละเอียด',
  'Retention campaign': 'แคมเปญรักษาลูกค้า',
  'Optional project note': 'โน้ตโปรเจกต์ ถ้ามี',
  'Start date': 'วันเริ่ม',
  'End date': 'วันจบ',
  Create: 'สร้าง',
  'Creating...': 'กำลังสร้าง...',
  'Project create failed.': 'สร้างโปรเจกต์ไม่สำเร็จ',
  'Project created.': 'สร้างโปรเจกต์แล้ว',
  'Owned projects': 'โปรเจกต์ของฉัน',
  'Shared with you': 'โปรเจกต์ที่แชร์มา',
  'No owned projects yet.': 'ยังไม่มีโปรเจกต์ของฉัน',
  'No shared projects yet.': 'ยังไม่มีโปรเจกต์ที่แชร์มา',
  Active: 'กำลังทำ',
  Completed: 'เสร็จแล้ว',
  Archived: 'เก็บถาวร',
  Duration: 'ช่วงเวลา',
  'Not set': 'ยังไม่ตั้ง',
  'Open end': 'ไม่กำหนดวันจบ',
  Until: 'ถึง',
  'Save status': 'บันทึกสถานะ',
  'Project status updated.': 'อัปเดตสถานะโปรเจกต์แล้ว',
  'Project status update failed.': 'อัปเดตสถานะโปรเจกต์ไม่สำเร็จ',
  'Save duration': 'บันทึกช่วงเวลา',
  'Project duration updated.': 'อัปเดตช่วงเวลาโปรเจกต์แล้ว',
  'Project duration update failed.': 'อัปเดตช่วงเวลาโปรเจกต์ไม่สำเร็จ',
  'Share project': 'แชร์โปรเจกต์',
  'Project role': 'สิทธิ์โปรเจกต์',
  Share: 'แชร์',
  'Project shared.': 'แชร์โปรเจกต์แล้ว',
  'Project share failed.': 'แชร์โปรเจกต์ไม่สำเร็จ',
  'No teammates available': 'ยังไม่มีเพื่อนร่วมทีมให้แชร์',
  'Shared teammates': 'เพื่อนร่วมทีมที่แชร์แล้ว',
  'No shared teammates yet.': 'ยังไม่ได้แชร์ให้ใคร',
  'Remove access': 'ลบสิทธิ์',
  'Project access removed.': 'ลบสิทธิ์โปรเจกต์แล้ว',
  'Project access remove failed.': 'ลบสิทธิ์โปรเจกต์ไม่สำเร็จ',
  'No description': 'ไม่มีรายละเอียด',
  Tasks: 'งาน',
  'Add task': 'เพิ่มงาน',
  'Task title': 'ชื่องาน',
  'Task assignee': 'ผู้รับผิดชอบงาน',
  'Task due date': 'วันครบกำหนดงาน',
  ...
  'Project task created.': 'สร้างงานแล้ว',
  'Project task create failed.': 'สร้างงานไม่สำเร็จ',
  'Project task updated.': 'อัปเดตงานแล้ว',
  ...
  'Subscription and usage': 'แพ็กเกจและการใช้งาน',
  'Market-adjusted pricing for repeat customer intelligence, imports, collaboration, and database storage.':
    'ราคาที่ปรับตามตลาดสำหรับระบบวิเคราะห์ลูกค้าซื้อซ้ำ การนำเข้าไฟล์ การทำงานร่วมกัน และพื้นที่ฐานข้อมูล',
  ...
  'Monthly orders': 'ออเดอร์รายเดือน',
  'Database storage': 'พื้นที่ฐานข้อมูล',
  'Manage billing': 'จัดการ billing',
  'Opening...': 'กำลังเปิด...',
  Starter: 'Starter',
  Growth: 'Growth',
  Scale: 'Scale',
  Enterprise: 'Enterprise',
  'For small shops validating repeat-customer work.': 'สำหรับร้านเล็กที่กำลังพิสูจน์งานลูกค้าซื้อซ้ำ',
  'For growing teams importing orders every week.': 'สำหรับทีมที่โตขึ้นและนำเข้าออเดอร์ทุกสัปดาห์',
  'For multi-channel operators with serious retention volume.': 'สำหรับทีมหลายช่องทางที่มี volume retention จริงจัง',
  'For custom data volume, storage, and support needs.': 'สำหรับ volume, storage และ support แบบ custom',
  Custom: 'Custom',
  mo: 'เดือน',
  'DB storage': 'พื้นที่ DB',
  Workspaces: 'Workspace',
  Integrations: 'Integration',
  'CSV/XLSX marketplace imports': 'นำเข้าไฟล์ marketplace แบบ CSV/XLSX',
  'Repeat dashboard': 'แดชบอร์ดลูกค้าซื้อซ้ำ',
  'Project collaboration': 'ทำงานร่วมกันในโปรเจกต์',
  'More order volume': 'รองรับออเดอร์มากขึ้น',
  'More teammates': 'เพิ่มเพื่อนร่วมทีมได้มากขึ้น',
  'Native integration headroom': 'มี headroom สำหรับ native integrations',
  'High-volume imports': 'นำเข้าไฟล์ volume สูง',
  'More stores and workspaces': 'เพิ่ม store และ workspace ได้มากขึ้น',
  'Priority operating capacity': 'capacity การใช้งานสูงขึ้น',
  'Custom storage': 'Storage แบบ custom',
  'Custom limits': 'Limit แบบ custom',
  'Dedicated onboarding': 'Onboarding เฉพาะทีม',
  Current: 'ปัจจุบัน',
  'Update checkout': 'อัปเดต checkout',
  'Choose plan': 'เลือกแพ็กเกจ',
  'Contact for enterprise': 'ติดต่อสำหรับ Enterprise',
  'Billing checkout did not return a URL.': 'Billing checkout ไม่ได้ส่ง URL กลับมา',
  'Billing portal did not return a URL.': 'Billing portal ไม่ได้ส่ง URL กลับมา',
  ...
  'This invitation link is invalid or has been revoked.': 'ลิงก์คำเชิญนี้ไม่ถูกต้องหรือถูกยกเลิกแล้ว',
  pending: 'รอรับคำเชิญ',
  expired: 'หมดอายุ',
  accepted: 'รับแล้ว',
  'Invited email': 'อีเมลที่ถูกเชิญ',
  'This invitation has expired. Ask an admin to send a new invite.':
    'คำเชิญนี้หมดอายุแล้ว ให้ admin ส่งคำเชิญใหม่',
